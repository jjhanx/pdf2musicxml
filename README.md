...
- **Audiveris 후처리 (최근)**: 세잇단 **쉼표 없음→`show-bracket=no`(숫자만)**, **쉼표 포함→bracket 유지**. **조바꿈 마디 F 조표 오인** — F `<clef>` 제거·`<key>` 보충·**이웃 마디 대비 1~2옥타브 낮은 pitch 자동 보정**. 화음 멤버 beam 일괄 제거·마디 임시표 역전파·m50 전용 accidental 패치는 **제거**(범용 오류 유발).
