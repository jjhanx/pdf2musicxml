...
| `POST /api/review/:jobId/reset-lyrics-initial` | OMR·HITL **이후** `review_needed` 단계만. 원본 PDF **1차 추출**(PyMuPDF 전체 + pdfplumber 가사 보강)로 되돌림. 응답은 갱신된 검토 항목 배열 |
