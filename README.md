...
- **문자-악보 사전 매핑 및 마스킹 (Pre-Audiveris UI)**: Audiveris 악보 인식 전에 팝업을 띄워 인식된 글자들의 역할을 지정(`제목`, `작사가`, `가사` 등)합니다. 지정된 영역은 Audiveris에 넘어가기 전 하얗게 마스킹되어 악보 기호와 혼동되는 것을 막습니다. 특히 **가사** 항목은 몇 개의 음표에 걸쳐 있는지 **음표 수**를 지정하고 해당 칸에 한 글자씩 정확하게 분배할 수 있어, 복잡한 리듬이나 쉼표가 섞인 곡에서도 가사를 정확히 주입할 수 있습니다.
