...
| `MASK_PDF_LYRIC_REDACT_MIN_HEIGHT_PT` | 선택 가사 **리덕 사각형** 세로 최소 pt(기본 **`0.35`**, `0`=비활성). 세로 높이가 극히 작은 글림에서 리덕이 한 겹만 지우는 경우 완화. |
