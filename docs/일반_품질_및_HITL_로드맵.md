...
| 두 마디에 걸친 diminuendo/crescendo를 못 그림 | 마디 편집 **「다음 마디 포함」** + wedge `toMeasureMxl`(start m.N · stop m.N+1). `python _smoke/test_cross_measure_wedge_hitl.py` | 42마디 열고 포함 켠 뒤 끝 음을 43마디에서 선택 |
