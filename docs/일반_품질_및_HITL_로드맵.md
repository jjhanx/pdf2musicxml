...
| tenuto·accent 등이 음표 위/아래·이음줄과 겹침 | Accent는 음표에 유지. 거리 드롭다운은 CSS `--hitl-art-dy`로 즉시 이동. `npx tsx _smoke/test_articulation_pending_preview.ts` | 마디 편집 거리. 저장 MXL은 「MXL에 반영」 |
