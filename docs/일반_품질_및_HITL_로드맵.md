...
| tenuto·accent 거리 미리보기 | 글리프 transform + MXL 반영 후 XML 힌트(피치 폴백·Audiveris 절대 dy 무시). `npx tsx _smoke/test_articulation_yshift_draw.ts` | 마디 편집 거리. 「MXL에 반영」 후 원위치 복귀 없는지 |
