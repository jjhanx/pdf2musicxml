...
| tenuto·accent 거리 미리보기 | **원인:** OSMD 로컬 마디(0…)≠HITL 51. **해결:** `resolveOsmdGraphicMeasureMxl` + path 표별 Y. 검증: `npx tsx _smoke/test_m51_b4_dual_art.ts` · `npx tsx _smoke/test_dual_articulation_distance.ts` | 경량 미리보기 m51 #1 B4에서 Tenuto2·Accent5 독립 |
