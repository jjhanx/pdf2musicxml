...
| tenuto·accent 거리 미리보기 | 상대 `(spaces−1)` 이동은 네이티브 스택과 상쇄되어 gap≈0. 복수 표는 SVG text overlay(절대 Y), fromDirect 스킵. 검증: `test_exact_ui_distance_path.ts` | 51마디 #1 B4 Tenuto/Accent 거리 독립 |
