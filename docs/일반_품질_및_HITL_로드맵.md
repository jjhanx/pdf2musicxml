...
| tenuto·accent 거리 미리보기 | 복수 표(pending·XML 힌트)는 상대 이동 스킵 + SVG text overlay(절대 Y). add 힌트 보강·인접 칸 +2 스택. 검증: `test_c0b3_m51_live_path.ts` · `test_cmp_m49_m51_arts.ts` | 51마디 #1 B4 Tenuto/Accent 거리 독립 |
