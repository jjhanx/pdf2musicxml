...
| 마디 중간에 음자리표 전환 필요 | 삽입 폼 **음자리표 삽입**. 미리보기: mid clef 보존 + **마지막 음 뒤 clef는 비가시 쉼표 앵커**로 OSMD in-staff 표시. `npx tsx _smoke/test_mid_clef_trailing_osmd_anchor.ts` | 「여기 뒤」 후 𝄞/𝄢 · Ctrl+Shift+R 후 확인 |
