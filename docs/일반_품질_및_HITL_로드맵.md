...
| tenuto·accent 거리 미리보기 | VexFlow는 y_shift 무시·text_line으로 배치. HITL 칸→text_line 패치 후 re-render. load XML에 pending 표 삽입. 검증: `test_art_text_line_distance.ts` | 51마디 #1 B4 Tenuto/Accent 거리 독립 |
