...
| PR 8va가 마디 끝에서 최종 MXL에 안 보임 | timeline rebuild가 octave-shift stop을 backup 뒤 PL 앞으로 이동. stop은 attachment 유지·backup 전 복구. faithful 미리보기는 octave-shift 유지. `python _smoke/test_octave_shift_stop_before_backup.py` | HITL 동기화·결과 재생성 |
