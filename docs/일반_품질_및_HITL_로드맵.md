...
| 빔과 이음줄이 같은 쪽에 겹침 | 미리보기: 빔+줄기쪽 placement면 slur bezier를 **오선 1칸** 밖으로 (`prepareGraphicalSlursForOsmdPreview`). 저장 MXL 불변. `npx tsx _smoke/test_beam_slur_clearance.ts` | OSMD 미리보기 자동. 곡·마디 하드코딩 없음 |
