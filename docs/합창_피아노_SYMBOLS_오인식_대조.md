...
- **원인**: 첫 두 세잇단 묶음은 1·2slice가 stem-up·무빔 없음, 3slice부터 stem-down 빔 — Audiveris BEAMS/RHYTHMS가 4분 2개+세잇단 6slice(8화음)로 읽음. B1·B2를 한 화음으로 합치기도 함.
- **MXL**: `fix_audiveris_mxl` `_repair_two_collapsed_triplet_spans` — 12slice(4×세잇단) 복구
